...
Realize o fork do repositório para sua conta.

Abra o ambiente do SQL no seu computador.

Realize as consultas.

Salve as consultas em um arquivo .sql

Após fazer todas as consultas e commitar todos os exercícios fazer o git push para seu fork.
...
-- SELECT * FROM musicas WHERE tempo < 300 AND compositor IS NOT NULL AND compositor != 'Bach'
...
-- SELECT * FROM musicas ORDER BY id LIMIT 10 OFFSET 30
